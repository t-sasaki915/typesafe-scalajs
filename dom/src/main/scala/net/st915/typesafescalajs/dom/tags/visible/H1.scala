...
object H1 {
  ...
  def apply(attributes: (AcceptAttribute, _)*)(children: Node*): H1 =
    H1(attributes.toSet, children.toList)

}

final case class H1(attributes: Set[(H1.AcceptAttribute, _)], children: List[Node])
